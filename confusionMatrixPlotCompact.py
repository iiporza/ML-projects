...
def confusionMatrixPlot2(model, dataloader, saveConfusionMatrix=None, saveFlag=bool):
    ...
    ax.set_xticklabels(ax.get_xticklabels(), fontsize=33)  # Change font size of x-axis tick labels
    ax.set_yticklabels(ax.get_yticklabels(), fontsize=33)  # Change font size of y-axis tick labels

    # Customize colorbar
    colorbar = ax.collections[0].colorbar
    colorbar.ax.tick_params(labelsize=33)  # Change font size of colorbar tick labels
